...
<BODY>
<img src="${pageContext.request.contextPath}/images/58c60c8c5a304.jpg" width="100%" height="100%" style="z-index:-100;position:absolute;left:0;top:0"> 
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/user/dologin"  method=post>
...
<TABLE cellSpacing=0 cellPadding=0 width=400 align=center border=0>
  ...
  <TR>
    <TD background=${pageContext.request.contextPath}/images/58c60c8c5a304.jpg height=300>
        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <td><a href="${pageContext.request.contextPath}/user/register">注册</a></td>
